...
class MANNCell():
    def __init__(self, lstm_size, memory_size, memory_dim, nb_reads,
        ...
        self.step = 0
        self.gamma = gamma
        self.controller = tf.compat.v1.nn.rnn_cell.BasicLSTMCell(self.lstm_size)
    ...
    def read_head_addressing(self, k, M_prev, eps=1e-8):
        with tf.compat.v1.variable_scope("read_head_addressing"):
    ...
    def write_head_addressing(self, sig_alpha, wr_prev, wlu_prev):
        with tf.compat.v1.variable_scope("write_head_addressing"):
